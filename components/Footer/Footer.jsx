...
export default function Footer() {
  return (
    <>
      <footer className="relative bg-[#1f2937] pt-8 pb-6 font-fontTh2 mt-24">
            ...
            <div className="w-full lg:w-6/12 px-4">
              <div className="flex flex-wrap items-top mb-6">
                <div className="w-full lg:w-4/12 px-4 ml-auto">
                  <span className="block uppercase text-md font-semibold mb-2 text-primary">
                    pages
                  </span>
                  <ul className="list-unstyled">
                    <li>
                      <a
                        className="font-semibold block pb-2 text-sm hover:underline"
                        href="../products"
                      >
                        สินค้า
                      </a>
                ...
                <div className="w-full lg:w-4/12 px-4">
                  ...
                  <ul className="list-unstyled">
                    <li>
                      <a
                        className="flex font-semibold block pb-2 text-sm hover:underline"
