    ...
    <>
      <div className="container pt-16 mx-auto font-fontTh2 p-4">
        {/* <div className="px-6 pb-2 mb-10 md:mb-24 ">
          <a
            href="../"
            className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-[#c94413] hover:underline  "
          >
            <svg
        ...
        <div className="flex mx-5 md:mx-10 flex-wrap-reverse mt-10">
          <div className="flex-auto w-96 md:mr-10 my-10 indent-8 ">
            <h4 className="text-lg text-[#c94413] font-semibold mb-5">
              หัวข้อย่อย
            </h4>
            <p>
        ...
        <div className="mx-10 mt-24 text-end text-[#c94413] hover:underline">
            <i>
