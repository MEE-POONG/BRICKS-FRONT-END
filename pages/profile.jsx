            ...
            {orderData?.map((order, index) => (
              <section key={index} className="px-4 mb-8  w-full lg:w-1/2 xl:w-1/3">
                <div className="shadow-lg rounded-lg min-w-full">
                  ...
                  <div className="flex my-2 mx-6">
                    <div>
                      <span className="text-3xl">วันที่สั่งซื้อ </span>
                      <span className="ml-2 font-semibold text-3xl">
                  ...
                  <div className="flex my-2 mx-6">
                    <div>
                      <span className="text-3xl">วันที่จัดส่ง </span>
                      <span className="ml-2 font-semibold text-3xl">
                        {order.deliveryAt
                    ...
                    {/* {order?.orderDetail?.map((product, index) => (
                      <div key={product.id} className="grid grid-cols-2 my-4">
                        ...
                        <div className="">
                          ...
                          <div className="text-3xl">จำนวน </div>
                          <div className="text-3xl">{product.sumQty.toLocaleString("en-US")} </div>
                          <div className="text-3xl">ราคา{product.sumPrice.toLocaleString("en-US")}</div>
                        </div>
                      </div>
                    ))} */}
                            ...
                            return (
                              <div class="w-full p-4 text-3xl min-w-full">
                                <a href="" class="c-card block bg-white shadow-md hover:shadow-xl rounded-lg overflow-x-auto">
                                  ...
                                  <div class="p-4">
                                    <span class="inline-block px-2 py-1 leading-none bg-orange-200 text-orange-800 rounded-full font-semibold uppercase tracking-wide text-base">Highlight</span>
                                    <h2 class="mt-2 mb-2  font-bold">{product.products.name}</h2>
                                    <p class="text-xl" dangerouslySetInnerHTML={{ __html: product.products.detail }}></p>
                                    {/* {JSON.stringify(product.products)} */}
                                  </div>
                                  <div class="p-4 border-t border-b text-xl text-gray-700">
                                    <div class="flex items-center">
                                      <span class="text-xl font-semibold">จำนวน</span>&nbsp;<span class="font-bold text-xl">{product.sumQty.toLocaleString("en-US")}</span>&nbsp;<span class="text-xl font-semibold">ชิ้น</span>
                                    </div>
                                  </div>
                                  <div class="p-4 flex items-center text-sm text-gray-600">
                                    <div class="flex items-center">
                                      <span class="text-xl font-semibold">ราคา</span>&nbsp;<span class="font-bold text-xl">{product.sumPrice.toLocaleString("en-US")}</span>&nbsp;<span class="text-xl font-semibold">฿</span>
                                    </div>
                                  </div>
                                </a>
                              </div>
